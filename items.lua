return {
	...
	PlaceObj('ModItemFolder', {
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			EnableAimFX = true,
			GBO_ComponentTraits = "Scope.ReflexAdvanced, Base.LaserDot",
			GBO_OverrideModes = {
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			GBO_ComponentTraits = "Base.NoStock",
			GBO_OverrideEffects = {
				"zzStockEquipped",
			},
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			GBO_ComponentTraits = "Scope._1dot5x",
			GBO_OverrideModes = {
				PlaceObj('GBO_ComponentModeOverride', {
					'Mode', "oldCTH",
					'Effects', {
		...
		PlaceObj('ModItemWeaponComponent', {
			DisplayName = T(172235770884, --[[ModItemWeaponComponent _Master_VigM2_Stock_fld_TOG_OLD_PARAMS DisplayName]] "Folded Stock"),
			GBO_ComponentTraits = "Self",
			GBO_OverrideEffects = {
				"zzStockEquipped",
				"IncreaseOverwatchAngle",
			...
			group = "Stock",
			id = "_Master_VigM2_Stock_fld_TOG_OLD_PARAMS",
			zzFoldingPair = {
				"VigM2_Stock_unfld_1",
			},
		}),
		PlaceObj('ModItemWeaponComponent', {
			DisplayName = T(126346920217, --[[ModItemWeaponComponent _Master_VigM2_Stock_unfld_TOG DisplayName]] "Light Stock"),
			GBO_ComponentTraits = "Stock.Light",
		...
		PlaceObj('ModItemWeaponComponent', {
			DisplayName = T(953098212505, --[[ModItemWeaponComponent _Master_VigM2_Stock_unfld_TOG_OLDPARAMS DisplayName]] "Unfold Stock"),
			GBO_ComponentTraits = "Self",
			GBO_OverrideEffects = {
				"IncreaseAimAccuracy",
				"zzStockEquipped",
			...
			group = "Stock",
			id = "_Master_VigM2_Stock_unfld_TOG_OLDPARAMS",
			zzFoldingPair = {
				"VigM2_Stock_fld_1",
			},
		}),
		...
		PlaceObj('ModItemFolder', {
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "BarrelLong_handgun",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "BarrelLongImproved_handgun",
				Icon = "UI/Icons/Upgrades/galil_barrel_long",
				ModificationDifficulty = 0,
				ModificationEffects = {
					"IncreaseRange",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "BarrelLight",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "Suppressor",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "Compensator",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "StockHeavy",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "ScopeCOGQuick",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "WideScope",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "LROptics",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "PSG_DefaultScope",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "ReflexSightAdvanced",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "ReflexSightAdvanced_Glock",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "LROpticsAdvanced",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "ThermalScope",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				Cost = 20,
				DisplayName = T(129608310281, --[[ModItemWeaponComponent RAT_TOG_compactRS DisplayName]] "Compact Reflex Sight 1x"),
				GBO_ComponentAncestor = "ReflexSight",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				Cost = 20,
				DisplayName = T(633204289463, --[[ModItemWeaponComponent RAT_TOG_compactRS_rpk_mount DisplayName]] "Compact Reflex Sight 1x"),
				GBO_ComponentAncestor = "ReflexSight",
				Icon = "UI/Icons/Upgrades/compact_reflex_sight",
				ModificationDifficulty = 0,
				ModificationEffects = {
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				Cost = 20,
				DisplayName = T(422877531589, --[[ModItemWeaponComponent RAT_TOG_vigilanceRS DisplayName]] '"Vigilante" Reflex Sight 1x'),
				GBO_ComponentAncestor = "_ReflexSIghtVigilance",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				Cost = 20,
				DisplayName = T(921032371113, --[[ModItemWeaponComponent RAT_TOG_vigilanceRS_rpk_mount DisplayName]] '"Vigilante" Reflex Sight 1x'),
				GBO_ComponentAncestor = "_ReflexSIghtVigilance",
				Icon = "Mod/KQkEVHf/Icons/Upgrades/ToC_Scope_kentaur.png",
				ModificationDifficulty = 10,
				ModificationEffects = {
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "ScopeCOG",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "Flashlight",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				GBO_ComponentAncestor = "FlashlightDot",
			...
			PlaceObj('ModItemWeaponComponent', {
				...
				EnableAimFX = true,
				GBO_ComponentAncestor = "LaserDot",
